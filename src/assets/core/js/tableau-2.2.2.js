...
(function() {
  ...
  (function() {
    ...
    b.__typeName = 'tab.BaseLogAppender';
    global.tab.BaseLogAppender = b;
    var c = function() {
      this.$2 = null;
      b.call(this)
    };
    c.__typeName = 'tab.ConsoleLogAppender';
    global.tab.ConsoleLogAppender = c;
    var d = function() {};
    d.__typeName = 'tab.CookieHelper';
    d.getValueForCookie = function(o) {
      var p = e.getCookie().match(new RegExp('(?:^|;) ?' + o + '=([^;]*)(?:;|$)'));
      if (ss.isNullOrUndefined(p) || p.length < 2) {
        return null
      }
      return p[1]
    };
    d.setCookie = function(o, p, q, r) {
      var s = o + '=' + p + ';path=' + q + ';';
      if (!ss.staticEquals(r, null)) {
        s += 'expires=' + r.toUTCString()
      }
      e.setCookie(s)
    };
    global.tab.CookieHelper = d;
    var e = function() {};
    e.__typeName = 'tab.DocumentHelper';
    e.get_documentClientWidth = function() {
      return document.documentElement.clientWidth
    };
    e.get_documentClientHeight = function() {
      return document.documentElement.clientHeight
    };
    e.getCookie = function() {
      return document.cookie
    };
    e.setCookie = function(o) {
      document.cookie = o
    };
    global.tab.DocumentHelper = e;
    var f = function() {};
    f.__typeName = 'tab.EscapingUtil';
    f.escapeHtml = function(o) {
      var p = ss.coalesce(o, '');
    ...
    global.tab.EscapingUtil = f;
    var g = function() {};
    g.__typeName = 'tab.LazyUtil';
    g.lazyInitStaticField = function(o, p, q) {
      var r = o[p];
    ...
    global.tab.LazyUtil = g;
    var h = function() {};
    h.__typeName = 'tab.Log';
    h.get = function(o) {
      return j.lazyGetLogger(ss.getInstanceType(o))
    };
    global.tab.Log = h;
    var i = function(o) {
      this.$0 = null;
    ...
    i.__typeName = 'tab.LogAppenderInstance';
    global.tab.LogAppenderInstance = i;
    var j = function(o) {
      this.$1 = null;
      this.$1 = o
    };
    j.__typeName = 'tab.Logger';
    j.get_globalLog = function() {
      return j.global
    };
    j.$2 = function() {
      return g.lazyInitStaticField(j, 'appenders', function() {
        return []
      })
    };
    j.$3 = function() {
      return g.lazyInitStaticField(j, 'filters', function() {
        return []
      })
    };
    j.$4 = function() {
      return g.lazyInitStaticField(j, 'nullLog', function() {
        return new j('')
      })
    };
    j.clearFilters = function() {
      var o = j.$2();
      for (var p = 0; p < o.length; p++) {
        var q = o[p];
        q.clearFilters()
      }
      j.$3().splice(0, j.$3().length)
    };
    j.filterByLogger = function(o, p) {
      p = p || 0;
      j.$0(function(q, r) {
        return ss.referenceEquals(q, o) && r >= p
      })
    };
    j.filterByType = function(o, p) {
      p = p || 0;
      j.$0(function(q, r) {
        return r >= p && ss.referenceEquals(q.get_name(), ss.getTypeName(o))
      })
    };
    j.filterByName = function(o, p) {
      p = p || 0;
      var q = new RegExp(o, 'i');
      j.$0(function(r, s) {
        return s >= p && ss.isValue(r.get_name().match(q))
      })
    };
    j.clearAppenders = function() {
      j.$2().splice(0, j.$3().length)
    };
    j.hasAppender = function(o) {
      return j.$2().indexOf(o) > -1
    };
    j.addAppender = function(o) {
      var p = j.$3();
    ...
    j.removeAppender = function(o) {
      var p = j.$2().indexOf(o);
      if (p > -1) {
        j.$2().splice(p, 1)
      }
    };
    j.lazyGetLogger = function(o) {
      return g.lazyInitStaticField(o, '_logger', function() {
        return j.getLogger(o)
      })
    };
    j.getLogger = function(o, p) {
      var q = j.getLoggerWithName(ss.getTypeName(o));
      if (ss.isValue(p)) {}
      return q
    };
    j.getLoggerWithName = function(o) {
      return j.$4()
    };
    j.$1 = function() {
      var o = m.getUriQueryParameters(window.self.location.search);
      if (!ss.keyExists(o, ':log')) {
        return
      }
      var p = o[':log'];
      if (p.length === 0) {}
      for (var q = 0; q < p.length; q++) {
        var r = p[q];
        var s = r.split(String.fromCharCode(58));
        var t = 1;
        if (s.length > 0 && ss.isValue(s[1])) {
          var u = s[1].toLowerCase();
          var v = j.loggerLevelNames.indexOf(u);
          if (v >= 0) {
            t = v
          }
        }
    ...
    global.tab.Logger = j;
    var k = function() {};
    k.__typeName = 'tab.LoggerLevel';
    global.tab.LoggerLevel = k;
    var l = function() {};
    l.__typeName = 'tab.ScriptEx';
    global.tab.ScriptEx = l;
    var m = function() {};
    m.__typeName = 'tab.UriExtensions';
    m.getUriQueryParameters = function(o) {
      var p = {};
      ...
      for (var u = 0; u < t.length; u++) {
        ...
        if (w.length > 1) {
          y.push(decodeURIComponent(w[1]))
        }
      }
      return p
    };
    global.tab.UriExtensions = m;
    var n = function(o) {
      this.$0 = null;
      this.$0 = o
    };
    n.__typeName = 'tab.WindowHelper';
    n.get_windowSelf = function() {
      return window.self
    };
    n.get_windowParent = function() {
      return window.parent
    };
    n.get_selection = function() {
    ...
    n.getOpener = function(o) {
      return o.opener
    };
    n.getLocation = function(o) {
      return o.location
    };
    n.getPathAndSearch = function(o) {
      return o.location.pathname + o.location.search
    };
    n.setLocationHref = function(o, p) {
      o.location.href = p
    };
    n.locationReplace = function(o, p) {
      o.location.replace(p)
    };
    n.open = function(o, p, q) {
      return window.open(o, p, q)
    };
    n.reload = function(o, p) {
      o.location.reload(p)
    };
    n.requestAnimationFrame = function(o) {
      return n.$c(o)
    };
    n.cancelAnimationFrame = function(o) {
      if (ss.isValue(o)) {
        n.$b(o)
      }
    };
    n.setTimeout = function(o, p) {
      return window.setTimeout(o, p)
    };
    n.setInterval = function(o, p) {
      return window.setInterval(o, p)
    };
    n.addListener = function(o, p, q) {
      if ('addEventListener' in o) {
        o.addEventListener(p, q, false)
      } else {
        o.attachEvent('on' + p, q)
      }
    };
    n.removeListener = function(o, p, q) {
      if ('removeEventListener' in o) {
        o.removeEventListener(p, q, false)
      } else {
        o.detachEvent('on' + p, q)
      }
    };
    n.$0 = function() {
      var o = 0;
      n.$c = function(p) {
        ...
        var r = Math.max(0, 16 - (q - o));
        o = q + r;
        var s = window.setTimeout(p, r);
        return s
      }
    };
    n.clearSelection = function() {
      var o = n.get_selection();
      if (ss.isValue(o)) {
        if (typeof(o['removeAllRanges']) === 'function') {
          o.removeAllRanges()
        } else if (typeof(o['empty']) === 'function') {
          o['empty']()
        }
      }
    };
    global.tab.WindowHelper = n;
    ss.initClass(b, a, {
      ...
      log: function(o, p, q, r) {},
      logInternal: null,
      formatMessage: function(o, p) {
        if (ss.isNullOrUndefined(p) || p.length === 0) {
          return o
        }
        var q = new ss.StringBuilder;
        var r = 0;
        var s = false;
    ...
    ss.initClass(c, a, {
      logInternal: function(o, p, q, r) {
        ...
        var s = [];
        var t = s.concat(q);
        s = t.concat.apply(t, r);
        try {
          Function.prototype.apply.call(this.$1(p), window.console, s)
        } catch (u) {}
      },
      $1: function(o) {
        var p = window.self['console'];
        if (ss.isNullOrUndefined(this.$2)) {
          this.$2 = {};
          this.$2[(1).toString()] = p.log;
          this.$2[(4).toString()] = p.error;
          this.$2[(2).toString()] = p.info;
          this.$2[(3).toString()] = p.warn
        }
        var q = this.$2[o.toString()];
    ...
    ss.initClass(i, a, {
      ...
      set_instance: function(o) {
        this.$1$1 = o
      },
      enableLogging: function(o) {
        if (ss.isNullOrUndefined(this.get_instance())) {
          this.set_instance(this.$0());
          j.addAppender(this.get_instance())
        } else if (!j.hasAppender(this.get_instance())) {
          j.addAppender(this.get_instance())
        }
        this.get_instance().addFilter(ss.coalesce(o, function(p, q) {
          return true
        }))
      },
      disableLogging: function() {
        ...
        j.removeAppender(this.get_instance());
    ...
    (function() {
      j.global = j.getLoggerWithName('global');
      j.loggerLevelNames = [];
      j.$5 = ':log';
      j.loggerLevelNames[0] = 'all';
      j.loggerLevelNames[1] = 'debug';
      j.loggerLevelNames[2] = 'info';
      j.loggerLevelNames[3] = 'warn';
      j.loggerLevelNames[4] = 'error';
      j.loggerLevelNames[5] = 'off'
    })();
    (function() {
      c.globalAppender = new i(function() {
        return new c
      })
    })();
    (function() {
      ...
      if ('screenTop' in window) {
        ...
        for (var t = 0; t < q.length && (ss.isNullOrUndefined(r) || ss.isNullOrUndefined(s)); ++t) {
          var u = q[t];
          var v = u + 'RequestAnimationFrame';
          if (ss.isNullOrUndefined(r) && v in window) {
            r = v
          }
          if (ss.isNullOrUndefined(s)) {
            v = u + 'CancelAnimationFrame';
            if (v in window) {
              s = v
            }
            v = u + 'CancelRequestAnimationFrame';
            if (v in window) {
              s = v
            }
          }
  ...
  (function() {
    ...
    f.$1 = function(e) {
      return function() {
        ...
        if (ss.isNullOrUndefined(bj)) {
          throw q.createInternalError("No creation function has been registered for interface type '" + bh + "'.")
        }
        var bk = bj();
        return bk
      }
    ...
    m.type = function(e) {
      return (ss.isNullOrUndefined(e) ? String(e) : (m.$8[m.$d.call(e)] || 'object'))
    };
    m.trim = function(e) {
      if (ss.isValue(m.$e)) {
        return (ss.isNullOrUndefined(e) ? '' : m.$e.call(e))
      }
      return (ss.isNullOrUndefined(e) ? '' : e.toString().replace(m.$f, '').replace(m.$g, ''))
    };
    m.parseJSON = function(e) {
      ...
      if (m.$a.test(e.replace(m.$b, '@').replace(m.$c, ']').replace(m.$9, ''))) {
    ...
    q.createInternalError = function(e) {
      if (ss.isValue(e)) {
        return q.create('internalError', 'Internal error. Please contact Tableau support with the following information: ' + e)
      } else {
        return q.create('internalError', 'Internal error. Please contact Tableau support')
      }
    };
    ...
    q.createNotActiveSheet = function() {
      return q.create('notActiveSheet', 'Operation not allowed on non-active sheet')
    };
    q.createInvalidCustomViewName = function(e) {
      return q.create('invalidCustomViewName', 'Invalid custom view name: ' + e)
    };
    ...
    q.createInvalidFilterFieldNameOrValue = function(e) {
      return q.create('invalidFilterFieldNameOrValue', 'Invalid filter field name or value: ' + e)
    };
    ...
    q.createNullOrEmptyParameter = function(e) {
      return q.create('nullOrEmptyParameter', 'Parameter cannot be null or empty: ' + e)
    };
    q.createMissingMaxSize = function() {
      return q.create('missingMaxSize', 'Missing maxSize for SheetSizeBehavior.ATMOST')
    };
    q.createMissingMinSize = function() {
      return q.create('missingMinSize', 'Missing minSize for SheetSizeBehavior.ATLEAST')
    };
    q.createMissingMinMaxSize = function() {
      return q.create('missingMinMaxSize', 'Missing minSize or maxSize for SheetSizeBehavior.RANGE')
    };
    q.createInvalidRangeSize = function() {
      return q.create('invalidSize', 'Missing minSize or maxSize for SheetSizeBehavior.RANGE')
    };
    ...
    q.createSizeConflictForExactly = function() {
      return q.create('invalidSize', 'Conflicting size values for SheetSizeBehavior.EXACTLY')
    };
    q.createInvalidSizeBehaviorOnWorksheet = function() {
      return q.create('invalidSizeBehaviorOnWorksheet', 'Only SheetSizeBehavior.AUTOMATIC is allowed on Worksheets')
    };
    q.createNoUrlForHiddenWorksheet = function() {
      return q.create('noUrlForHiddenWorksheet', 'Hidden worksheets do not have a URL.')
    };
    q.createInvalidAggregationFieldName = function(e) {
      return q.create('invalidAggregationFieldName', "Invalid aggregation type for field '" + e + "'")
    };
    q.createInvalidToolbarButtonName = function(e) {
      return q.create('invalidToolbarButtonName', "Invalid toolbar button name: '" + e + "'")
    };
    ...
    q.createBrowserNotCapable = function() {
      return q.create('browserNotCapable', 'This browser is incapable of supporting the Tableau JavaScript API.')
    };
    ...
    r.hasClass = function(e, bh) {
      var bi = new RegExp('[\\n\\t\\r]', 'g');
      return ss.isValue(e) && (' ' + e.className + ' ').replace(bi, ' ').indexOf(' ' + bh + ' ') > -1
    };
    ...
    r.isElementOfTag = function(e, bh) {
      return ss.isValue(e) && e.nodeType === 1 && ss.referenceEquals(e.tagName.toLowerCase(), bh.toLowerCase())
    };
    ...
    r.visibleContentRectInDocumentCoordinates = function(e) {
      ...
      for (var bi = e.parentElement; ss.isValue(bi) && ss.isValue(bi.parentElement); bi = bi.parentElement) {
    ...
    r.getVisualViewportRect = function(e) {
      var bh = e.visualViewport;
      if (ss.isValue(bh)) {
        return new p(ss.Int32.trunc(bh.pageLeft), ss.Int32.trunc(bh.pageTop), ss.Int32.trunc(bh.width), ss.Int32.trunc(bh.height))
      } else {
        return null
      }
    };
    r.$1 = function() {
      ...
      if (ss.isValue(e)) {
        ...
        var bh = r.contentRectInDocumentCoordinates(document.documentElement);
        var bi = new tab.WindowHelper(window.self);
        if (bi.isQuirksMode()) {
          bh.height = document.body.clientHeight - bh.left;
          bh.width = document.body.clientWidth - bh.top
        }
        bh.left += bi.get_pageXOffset();
        bh.top += bi.get_pageYOffset();
        return bh
      }
    };
    ...
    r.getDataValue = function(e) {
      ...
      return Q.$ctor(r.convertRawValue(e.value, e.type), e.formattedValue, e.aliasedValue)
    };
    ...
    r.noResultPromiseHelper = function(e, bh, bi) {
      ...
      var bk = new(ss.makeGenericType(N, [Object]))(e, 1, function(bl) {
        bj.resolve()
      }, function(bl, bm) {
    ...
    v.convertDashboardObjectType = function(e) {
      switch (e) {
        ...
        default:
        {
          throw q.createInternalError('Unknown ApiCrossDomainDashboardObjectType: ' + e)
        }
      }
    };
    v.convertDateRange = function(e) {
      switch (e) {
        ...
        default:
        {
          throw q.createInternalError('Unknown ApiCrossDomainDateRangeType: ' + e)
        }
      }
    };
    v.convertFieldAggregation = function(e) {
      switch (e) {
        ...
        default:
        {
          throw q.createInternalError('Unknown ApiCrossDomainFieldAggregationType: ' + e)
        }
      }
    };
    v.convertFieldRole = function(e) {
      switch (e) {
        ...
        default:
        {
          throw q.createInternalError('Unknown ApiCrossDomainFieldRoleType: ' + e)
        }
      }
    };
    ...
    v.convertParameterAllowableValuesType = function(e) {
      switch (e) {
        ...
        default:
        {
          throw q.createInternalError('Unknown ApiCrossDomainParameterAllowableValuesType: ' + e)
        }
      }
    };
    v.convertParameterDataType = function(e) {
      switch (e) {
        ...
        default:
        {
          throw q.createInternalError('Unknown ApiCrossDomainParameterDataType: ' + e)
        }
      }
    };
    ...
    var N = function(e) {
      ...
      ss.registerGenericClassInstance(bh, N, [e], {
    ...
    ss.initClass(l, a, {
      ...
      $0: function(e, bh) {
        ...
        this.$2.push(function(bj) {
          bj.then(e, bh).then(ss.mkdel(bi, bi.resolve), ss.mkdel(bi, bi.reject))
        });
    ...
    ss.initClass(O, a, {
      registerHandler: function(e) {
        ...
        if (ss.isValue(e.get_hostId()) || ss.isValue(this.$6[e.get_hostId()])) {
          throw q.createInternalError("Host '" + e.get_hostId() + "' is already registered.")
        }
        this.$8++;
        e.set_hostId(bh);
        this.$6[bh] = e;
      ...
      sendCommand: function(e) {
        return function(bh, bi, bj) {
          ...
          if (!r.hasWindowPostMessage() || ss.isNullOrUndefined(bk) || ss.isNullOrUndefined(bk.contentWindow)) {
            return
          }
      ...
      $1: function(e) {
        ...
        var bk = this.$6[bj];
        if (ss.isNullOrUndefined(bk) || !ss.referenceEquals(bk.get_hostId(), bi.get_hostId())) {
          bk = this.$0(bh)
        }
      ...
      $2: function(e) {
        ...
        if (bj.get_result() === 'api.success') {
          switch (bi.get_successCallbackTiming()) {
            ...
            default:
            {
              throw q.createInternalError('Unknown timing value: ' + bi.get_successCallbackTiming())
            }
          }
      ...
      $0: function(e) {
        ...
        try {
          while (bh.moveNext()) {
            var bi = bh.current();
            if (this.$6.hasOwnProperty(bi.key) && ss.referenceEquals(bi.value.get_iframe().contentWindow, e.source)) {
              return bi.value
            }
          }
        } finally {
    ...
    ss.initClass(R, a, {
        ...
        if (ss.isValue(bh)) {
          ...
          if (bh.rangeType === 'lastn' || bh.rangeType === 'nextn') {
            if (ss.isNullOrUndefined(bh.rangeN)) {
              throw q.create('missingRangeNForRelativeDateFilters', 'Missing rangeN field for a relative date filter of LASTN or NEXTN.')
            }
            bi['api.filterDateRange'] = bh.rangeN
          }
          if (ss.isValue(bh.anchorDate)) {
            bi['api.filterDateArchorValue'] = r.serializeDateForServer(bh.anchorDate)
          }
        }
        return bi
      },
      ...
      filterCommandError: function(e) {
        ...
        if (ss.isValue(bh) && ss.isValue(bh.errorCode)) {
          var bi = (ss.isValue(bh.additionalInformation) ? bh.additionalInformation.toString() : '');
          switch (bh.errorCode) {
      ...
      normalizeRangeFilterOption: function(e) {
        ...
        if (ss.isNullOrUndefined(e.min) && ss.isNullOrUndefined(e.max)) {
          throw q.create('invalidParameter', 'At least one of filterOptions.min or filterOptions.max must be specified.')
        }
        var bh = new Object;
        if (ss.isValue(e.min)) {
          bh.min = e.min
        ...
        if (ss.isValue(e.nullOption)) {
          bh.nullOption = Y.normalizeEnum(D).call(null, e.nullOption, 'filterOptions.nullOption')
        }
        return bh
      },
      normalizeRelativeDateFilterOptions: function(e) {
        ...
        var bh = new Object;
        bh.rangeType = Y.normalizeEnum(t).call(null, e.rangeType, 'filterOptions.rangeType');
        bh.periodType = Y.normalizeEnum(G).call(null, e.periodType, 'filterOptions.periodType');
        if (bh.rangeType === 'lastn' || bh.rangeType === 'nextn') {
      ...
      createFilterCommandReturnHandler: function(e, bh, bi) {
        return new(ss.makeGenericType(N, [Object]))(e, 0, ss.mkdel(this, function(bj) {
    ...
    ss.initClass(S, a, {
      ...
      getSummaryDataResponseHandler: function(e) {
        return new(ss.makeGenericType(N, [Object]))('api.GetSummaryTableCommand', 0, ss.mkdel(this, function(bh) {
          var bi = bh;
      ...
      getUnderlyingDataResponseHandler: function(e) {
        return new(ss.makeGenericType(N, [Object]))('api.GetUnderlyingTableCommand', 0, ss.mkdel(this, function(bh) {
          var bi = bh;
          var bj = this.processGetDataPresModel(bi);
          e.resolve(bj)
        }), function(bh, bi) {
      ...
      $0: function(e) {
        ...
        for (var bi = 0; bi < e.length; bi++) {
          var bj = e[bi];
          var bk = new j(bj.fieldName, v.convertDataType(bj.dataType), bj.isReferenced, bj.index);
          bh.push(new bd(bk))
        }
        return bh
      }
    ...
    (function() {
      ...
      m.$6 = 'regexp';
      m.$7 = 'string';
      m.$8 = ss.mkdict(['[object Boolean]', 'boolean', '[object Number]', 'number', '[object String]', 'string', '[object Function]', 'function', '[object Array]', 'array', '[object Date]', 'date', '[object RegExp]', 'regexp', '[object Object]', 'object']);
  ...
  (function() {
    ...
    var g = function(e) {
      ...
      this.$b = tab.ApiEnumConverter.convertParameterAllowableValuesType(e.allowableValuesType);
    ...
    k._makeCurrentCustomViewDefaultAsync = function(e, bm) {
      ...
      var bo = {};
      var bp = k.$0('api.MakeCurrentCustomViewDefaultCommand', bn, function(bq) {
    ...
    k._getCustomViewsAsync = function(e, bm) {
      var bn = new tab._Deferred;
      var bo = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.FetchCustomViewsCommand', 0, function(bp) {
    ...
    k.$0 = function(e, bm, bn) {
      ...
      return new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))(e, 0, bn, bo)
    };
    ...
    n.$1 = function(e) {
      var bm = tab.PublicEnums.normalizeEnum(tab.ApiSheetSizeBehavior).call(null, e.behavior, 'size.behavior');
      var bn = e.minSize;
      if (ss.isValue(bn)) {
    ...
    q.createContainedSheet = function(e, bm, bn, bo) {
      ...
      var bv = (bu ? '' : bt.getUrl());
      var bw = o.$ctor(e.name, bp, bq, br, bm.get_workbook(), bv, bs, bu, e.zoneId);
      if (e.sheetType === 'worksheet') {
        ...
        throw tab._TableauException.createInternalError("Unknown sheet type '" + e.sheetType + "'")
      }
    };
    ...
    t.$3 = function(e) {
      ...
      for (var bn = 0, bo = t.$5.length; bn < bo; bn++) {
        if (ss.referenceEquals(t.$5[bn].getParentElement(), bm)) {
          var bp = "Another viz is already present in element '" + tab._Utility.elementToString(bm) + "'.";
    ...
    var u = function(e, bm, bn) {
      ...
      if (ss.isValue(bn.height) || ss.isValue(bn.width)) {
        ...
        this.height = (ss.isValue(bn.height) ? tab._Utility.roundVizSizeInPixels(bn.height.toString()) : null);
        this.width = (ss.isValue(bn.width) ? tab._Utility.roundVizSizeInPixels(bn.width.toString()) : null)
      } else {
        this.fixedSize = false
      }
      ...
      if (ss.isNullOrUndefined(bp) || bp[0].toLowerCase().indexOf('http://') === -1 && bp[0].toLowerCase().indexOf('https://') === -1) {
    ...
    w.$1 = function(e) {
      ...
      if (ss.isValue(bm) && ss.isValue(bm.errorCode)) {
        var bn = (ss.isValue(bm.additionalInformation) ? bm.additionalInformation.toString() : '');
        switch (bm.errorCode) {
          case 'invalidFilterFieldName':
          {
    ...
    w.$0 = function(e) {
      ...
      if (ss.isValue(bm) && ss.isValue(bm.errorCode)) {
        ...
        switch (bm.errorCode) {
          ...
          {
            return tab._TableauException.create('invalidSelectionFieldName', bn)
          }
    ...
    H.clone = function(e) {
      return r.$ctor(e.caption, e.index, e.storyPointId, e.isActive, e.isUpdated, e.parentStoryImpl)
    };
    ...
    ss.initClass(k, a, {
      ...
      $2: function() {
        ...
        var bn = k.$0('api.UpdateCustomViewCommand', e, ss.mkdel(this, function(bo) {
      ...
      $1: function() {
        ...
        var bm = {};
        bm['api.customViewParam'] = this.$j;
        var bn = k.$0('api.RemoveCustomViewCommand', e, ss.mkdel(this, function(bo) {
          this.$f = true;
    ...
    ss.initClass(n, a, {
      ...
      changeSizeAsync: function(e) {
        ...
        var bp = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.SetSheetSizeCommand', 0, ss.mkdel(this, function(bq) {
          this.get_workbookImpl()._update(ss.mkdel(this, function() {
            var br = this.get_workbookImpl().get_publishedSheets()._get(this.get_name()).getSize();
            bm.resolve(br)
          }))
        }), function(bq, br) {
      ...
      $0: function(e) {
        ...
        if (e.behavior === 'automatic') {
          ...
          br['api.maxWidth'] = bp;
          br['api.maxHeight'] = bq;
          bm = tab.SheetSize.$ctor('exactly', tab.Size.$ctor(bn, bo), tab.Size.$ctor(bp, bq))
        }
        this.$8 = bm;
        return br
      }
      ...
      $c: function(e, bm) {
        ...
        for (var bn = 0; bn < e.length; bn++) {
          ...
          if (e[bn].objectType === 'worksheet') {
            ...
            var bw = (bv ? '' : bu.getUrl());
            var bx = o.$ctor(bq, 'worksheet', br, bs, this.get_workbook(), bw, bt, bv, bo.zoneId);
            var by = new w(bx, this.get_workbookImpl(), this.get_messagingOptions(), this);
            bp = by.get_worksheet();
    ...
    ss.initClass(p, a, {
      ...
      update: function(e) {
        ...
        var bv = ss.isNullOrUndefined(this.$g) || this.$g.get_storyPointId() !== bn.storyPointId;
        if (ss.isValue(this.$g) && bv) {
          this.$g.set_isActive(false)
        }
        var bw = this.$g;
        if (bv) {
          var bx = q.createContainedSheet(bm, this.get_workbookImpl(), this.get_messagingOptions(), this.$h);
          this.$g = new q(bn, bx)
        } else {
      ...
      activateStoryPointAsync: function(e) {
        ...
        var bo = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.ActivateStoryPoint', 0, ss.mkdel(this, function(bp) {
          this.$e(bp);
      ...
      revertStoryPointAsync: function(e) {
        ...
        var bn = {};
        bn['api.storyPointIndex'] = e;
        var bo = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.RevertStoryPoint', 0, ss.mkdel(this, function(bp) {
          this.$f(e, bp);
          bm.resolve(this.$j[e])
        }), function(bp, bq) {
          bm.reject(tab._TableauException.createServerError(bq))
      ...
      $c: function(e) {
        if (e !== 'api.ActivatePreviousStoryPoint' && e !== 'api.ActivateNextStoryPoint') {
          throw tab._TableauException.createInternalError("commandName '" + e + "' is invalid.")
        }
        var bm = new tab._Deferred;
        var bn = {};
        var bo = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))(e, 0, ss.mkdel(this, function(bp) {
          this.$e(bp);
          bm.resolve(this.$g.get_storyPoint())
        }), function(bp, bq) {
          bm.reject(tab._TableauException.createServerError(bq))
      ...
      $f: function(e, bm) {
        ...
        if (bn.storyPointId !== bm.storyPointId) {
          throw tab._TableauException.createInternalError("We should not be updating a story point where the IDs don't match. Existing storyPointID=" + bn.storyPointId + ', newStoryPointID=' + bm.storyPointId)
        }
      ...
      $e: function(e) {
        ...
        var bq = q.createContainedSheet(e.containedSheetInfo, this.get_workbookImpl(), this.get_messagingOptions(), this.$h);
        bp.isActive = true;
        this.$g = new q(bp, bq);
    ...
    ss.initClass(u, a, {
      ...
      $0: function() {
        ...
        var bm = !this.fixedSize && !(this.userSuppliedParameters.indexOf(':size=') !== -1) && this.parentElement.clientWidth * this.parentElement.clientHeight > 0;
        if (bm) {
          e.push(':size=');
        ...
        try {
          while (bo.moveNext()) {
            var bp = bo.current();
            if (bp.key !== 'embed' && bp.key !== 'height' && bp.key !== 'width' && bp.key !== 'device' && bp.key !== 'autoSize' && bp.key !== 'hideTabs' && bp.key !== 'hideToolbar' && bp.key !== 'onFirstInteractive' && bp.key !== 'onFirstVizSizeKnown' && bp.key !== 'toolbarPosition' && bp.key !== 'instanceIdToClone' && bp.key !== 'navType' && bp.key !== 'display_static_image') {
              e.push('&');
        ...
        if (ss.isValue(this.$1.navType) && this.$1.navType.length > 0) {
          e.push('navType=' + this.$1.navType.toString() + '&');
          e.push('navSrc=' + 'Opt'.toString())
        } else {
          e.push('navType=' + window.performance.navigation.type.toString() + '&');
    ...
    ss.initClass(v, a, {
      ...
      _revertAllAsync: function() {
        var e = new tab._Deferred;
        var bm = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.RevertAllCommand', 1, function(bn) {
          e.resolve()
        }, function(bn, bo) {
      ...
      $0: function(e, bm) {
        ...
        var bp = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.SwitchActiveSheetCommand', 0, ss.mkdel(this, function(bq) {
      ...
      _updateActiveSheetAsync: function() {
        ...
        var bn = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.UpdateActiveSheetCommand', 0, ss.mkdel(this, function(bo) {
      ...
      $5: function(e) {
        var bm = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.GetClientInfoCommand', 0, ss.mkdel(this, function(bn) {
          this.$a(bn);
          if (ss.isValue(e)) {
            e()
          }
      ...
      $9: function(e) {
        ...
        if (ss.isValue(this.$s)) {
          ...
          if (this.$s.get_sheetType() === 'story') {
            var bp = this.$s;
            bp.remove_activeStoryPointChange(ss.mkdel(this.$D, this.$D.raiseStoryPointSwitch))
          }
        }
        if (ss.isValue(this.$r)) {
          var bq = o.$ctor(this.$r.get_name(), 'worksheet', -1, this.$r.get_size(), this.get_workbook(), '', true, true, 4294967295);
          this.$r = null;
          ...
          if (br.sheetType === 'dashboard') {
            ...
            this.$s = bx;
            bx.add_activeStoryPointChange(ss.mkdel(this.$D, this.$D.raiseStoryPointSwitch))
          } else {
      ...
      $3: function(e) {
        ...
        for (var bn = 0; bn < bm.length; bn++) {
          ...
          if (ss.isNullOrUndefined(bq)) {
            ...
            var bu = o.$ctor(bp, bt, bn, br, this.get_workbook(), bo.repositoryUrl, bs, false, 4294967295);
            bq = new bc(bu);
            this.$A._add(bp, bq)
          } else {
            bq.$0.size = br
      ...
      $8: function(e) {
        ...
        var bn = {};
        var bo = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.FetchParametersCommand', 0, ss.mkdel(this, function(bp) {
          var bq = v.$3(e, bp);
          this.$w = bq;
          bm.resolve(bq.$8())
        }), function(bp, bq) {
      ...
      $7: function() {
        var e = new tab._Deferred;
        var bm = {};
        var bn = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.FetchParametersCommand', 0, ss.mkdel(this, function(bo) {
          this.$z = v.$4(bo);
      ...
      $2: function(e, bm) {
        ...
        this.$w = null;
        var bs = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.SetParameterValueCommand', 0, ss.mkdel(this, function(bt) {
          if (ss.isNullOrUndefined(bt)) {
            bn.reject(tab._TableauException.create('serverError', 'server error'));
            return
          }
    ...
    ss.initClass(w, a, {
      ...
      $r: function() {
        ...
        var bn = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.GetDataSourcesCommand', 0, function(bo) {
      ...
      $q: function(e) {
        ...
        var bo = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.GetDataSourceCommand', 0, function(bp) {
          var bq = m.processDataSource(bp);
          if (ss.isValue(bq)) {
            bm.resolve(bq.get_dataSource())
          } else {
            bm.reject(tab._TableauException.createServerError("Data source '" + e + "' not found"))
          }
        }, function(bp, bq) {
          bm.reject(tab._TableauException.createServerError(bq))
        });
      ...
      $G: function() {
        ...
        var bn = ss.isValue(this.get_parentStoryPointImpl()) && this.get_parentStoryPointImpl().get_parentStoryImpl().get_isActive();
        if (!e && !bm && !bn) {
      ...
      $d: function(e) {
        if (ss.isValue(this.get_parentStoryPointImpl())) {
          ...
          bm.dashboard = (ss.isValue(this.get_parentDashboardImpl()) ? this.$K.get_name() : this.get_name());
          bm.flipboardZoneId = this.get_parentStoryPointImpl().get_containedSheetImpl().get_zoneId();
          bm.storyboard = this.get_parentStoryPointImpl().get_parentStoryImpl().get_name();
          bm.storyPointId = this.get_parentStoryPointImpl().get_storyPointId();
          e['api.visualId'] = bm
        } else {
          var bn = (ss.isValue(this.get_parentDashboardImpl()) ? this.get_parentDashboardImpl().get_name() : null);
      ...
      $s: function(e, bm, bn) {
        if (!tab._Utility.isNullOrEmpty(e) && !tab._Utility.isNullOrEmpty(bm)) {
        ...
        var bp = {};
        this.$d(bp);
        if (!tab._Utility.isNullOrEmpty(bm) && tab._Utility.isNullOrEmpty(e)) {
        ...
        var bq = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.GetOneFilterInfoCommand', 0, ss.mkdel(this, function(br) {
          var bs = w.$1(br);
      ...
      $t: function(e) {
        ...
        var bo = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.GetFiltersListCommand', 0, ss.mkdel(this, function(bp) {
      ...
      $n: function(e) {
        ...
        this.$d(bn);
        var bo = this.$H.createFilterCommandReturnHandler('api.ClearFilterCommand', e, bm);
        this.sendCommand(Object).call(this, bn, bo);
        return bm.get_promise()
      },
      $f: function(e, bm, bn, bo) {
        ...
        this.$d(bq);
        var br = this.$H.createFilterCommandReturnHandler('api.ApplyCategoricalFilterCommand', e, bp);
      ...
      $j: function(e, bm) {
        ...
        this.$d(bn);
        var bo = new tab._Deferred;
        var bp = this.$H.createFilterCommandReturnHandler('api.ApplyRangeFilterCommand', e, bo);
      ...
      $l: function(e, bm) {
        ...
        this.$d(bn);
        var bo = new tab._Deferred;
        var bp = this.$H.createFilterCommandReturnHandler('api.ApplyRelativeDateFilterCommand', e, bo);
        this.sendCommand(Object).call(this, bn, bp);
        return bo.get_promise()
      },
      $h: function(e, bm, bn, bo) {
        ...
        var br = this.$H.createFilterCommandReturnHandler('api.ApplyHierarchicalFilterCommand', e, bq);
      ...
      $p: function() {
        ...
        var bm = {};
        this.$d(bm);
        var bn = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.ClearSelectedMarksCommand', 0, function(bo) {
          e.resolve()
        }, function(bo, bp) {
          e.reject(tab._TableauException.createServerError(bp))
        });
      ...
      $B: function(e, bm, bn) {
        ...
        if (tab._Utility.isString(e) && (tab._jQueryShim.isArray(bm) || tab._Utility.isString(bm) || !tab.PublicEnums.isValidEnum(tab.ApiSelectionUpdateType).call(null, bm))) {
      ...
      $v: function() {
        ...
        var bm = {};
        this.$d(bm);
        var bn = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.FetchSelectedMarksCommand', 0, ss.mkdel(this, function(bo) {
      ...
      $D: function(e, bm) {
        ...
        for (var bu = 0; bu < e.length; bu++) {
          var bv = e[bu];
          if (ss.isValue(bv.impl.get_tupleId()) && bv.impl.get_tupleId() > 0) {
            bt.push(bv.impl.get_tupleId())
          } else {
            var bw = bv.impl.get_pairs();
            for (var bx = 0; bx < bw.get__length(); bx++) {
              var by = bw.get_item(bx);
              if (by.hasOwnProperty('fieldName') && by.hasOwnProperty('value') && !tab._jQueryShim.isFunction(by.fieldName) && !tab._jQueryShim.isFunction(by.value)) {
      ...
      $A: function(e, bm, bn, bo, bp, bq, br, bs) {
        ...
        if (w.$2.test(br)) {
          ...
          if (ss.isValue(bt.nullOption)) {
            var bx = tab.PublicEnums.normalizeEnum(tab.ApiNullOption).call(null, bt.nullOption, 'options.nullOption');
            bu.nullOption = bx
          } else {
      ...
      $F: function(e, bm, bn, bo, bp, bq, br, bs) {
        var bt = {};
        this.$d(bt);
        bs = tab.PublicEnums.normalizeEnum(tab.ApiSelectionUpdateType).call(null, bs, 'updateType');
        bt['api.filterUpdateType'] = bs;
        if (!tab._Utility.isNullOrEmpty(e)) {
          bt['api.tupleIds'] = JSON.stringify(e)
        }
        if (!tab._Utility.isNullOrEmpty(bm) && !tab._Utility.isNullOrEmpty(bn)) {
        ...
        if (!tab._Utility.isNullOrEmpty(bo) && !tab._Utility.isNullOrEmpty(bp)) {
        ...
        if (!tab._Utility.isNullOrEmpty(bq) && !tab._Utility.isNullOrEmpty(br)) {
        ...
        if (tab._Utility.isNullOrEmpty(bt['api.tupleIds']) && tab._Utility.isNullOrEmpty(bt['api.categoricalFieldCaption']) && tab._Utility.isNullOrEmpty(bt['api.hierarchicalFieldCaption']) && tab._Utility.isNullOrEmpty(bt['api.rangeFieldCaption'])) {
          throw tab._TableauException.createInvalidParameter('fieldNameOrFieldValuesMap')
        }
        var bD = new tab._Deferred;
        var bE = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.SelectMarksCommand', 0, function(bF) {
          var bG = w.$0(bF);
      ...
      $o: function() {
        ...
        var bm = {};
        this.$d(bm);
        var bn = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.ClearHighlightedMarksCommand', 0, function(bo) {
          e.resolve()
        }, function(bo, bp) {
          e.reject(tab._TableauException.createServerError(bp))
        });
      ...
      $y: function(e, bm) {
        ...
        this.$d(bo);
        var bp = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.HighlightMarksCommand', 0, function(bq) {
          bn.resolve()
        }, function(bq, br) {
          bn.reject(tab._TableauException.createServerError(br))
        });
      ...
      $z: function(e, bm) {
        ...
        bo['api.Pattern'] = bm;
        this.$d(bo);
        var bp = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.HighlightMarksByPatternMatch', 0, function(bq) {
          bn.resolve()
        }, function(bq, br) {
          bn.reject(tab._TableauException.createServerError(br))
        });
      ...
      $u: function() {
        ...
        var bm = {};
        this.$d(bm);
        var bn = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.FetchHighlightedMarksCommand', 0, ss.mkdel(this, function(bo) {
    ...
    ss.initClass(D, a, {
      ...
      $1: function(e, bm) {
        if (e.get_name() === 'layoutInfoReq') {
          t.$1()
        } else if (e.get_name() === 'tableau.completed' || e.get_name() === 'completed') {
          bm.handleVizLoad()
    ...
    ss.initClass(M, a, {
      ...
      getCurrentUrlAsync: function() {
        var e = new tab._Deferred;
        var bm = new(ss.makeGenericType(tab.CommandReturnHandler$1, [String]))('api.GetCurrentUrlCommand', 0, function(bn) {
          e.resolve(bn)
        }, function(bn, bo) {
      ...
      handleVizLoad: function() {
        ...
        if (ss.isNullOrUndefined(this.$1s)) {
          this.$1s = new v(this, this.$1j, ss.mkdel(this, function() {
            this.$x(null)
          }))
        } else if (!this.$1g) {
      ...
      $1: function(e) {
        ...
        if (bn.behavior === 'exactly') {
          ...
          switch (bn.behavior) {
            case 'range':
            {
              bq = bn.minSize.width;br = bn.maxSize.width;bs = bn.minSize.height + bm;bt = bn.maxSize.height + bm;bo = Math.max(bq, Math.min(br, e.width));bp = Math.max(bs, Math.min(bt, e.height));
              break
            }
            case 'atleast':
            {
              bq = bn.minSize.width;bs = bn.minSize.height + bm;bo = Math.max(bq, e.width);bp = Math.max(bs, e.height);
              break
            }
            case 'atmost':
            {
              br = bn.maxSize.width;bt = bn.maxSize.height + bm;bo = Math.min(br, e.width);bp = Math.min(bt, e.height);
              break
            }
            case 'automatic':
            {
              bo = e.width;bp = Math.max(e.height, bm);
              break
            }
            default:
            {
              throw tab._TableauException.createInternalError('Unknown SheetSizeBehavior for viz: ' + bn.behavior.toString())
            }
          }
        }
      ...
      $K: function() {
        ...
        throw tab._TableauException.create('maxVizResizeAttempts', 'Viz resize limit hit. The calculated iframe size did not stabilize after ' + bm + ' resizes.')
      },
      ...
      addEventListener: function(e, bm) {
        var bn = {};
        if (!tab.PublicEnums.tryNormalizeEnum(tab.ApiTableauEventName).call(null, e, bn)) {
          throw tab._TableauException.createUnsupportedEventName(e.toString())
        }
        switch (bn.$) {
          case 'marksselection':
          {
      ...
      $N: function() {
        return tab._Utility.noResultPromiseHelper('api.RevertAllCommand', null, this.$1j)
      },
      $J: function() {
        return tab._Utility.noResultPromiseHelper('api.RefreshDataCommand', null, this.$1j)
      },
      $Y: function() {
      ...
      $4: function() {
        ...
        if (!this.$1n.fixedSize) {
          ...
          if (this.$1n.displayStaticImage) {
            this.$1o = this.$6(tab.Size.$ctor(parseInt(this.$1n.width), parseInt(this.$1n.height)));
            this.$1o.style.display = 'block'
          }
          this.$1e = this.$5();
          this.$S()
      ...
      $O: function() {
        try {
          if (!tab._Utility.hasWindowPostMessage() || ss.isNullOrUndefined(this.$1e) || !ss.isValue(this.$1e.contentWindow)) {
            return
          }
        } catch (bo) {
          return
        }
        var e = tab._Utility.visibleContentRectInDocumentCoordinates(this.get_iframe());
        var bm = tab._Utility.contentRectInDocumentCoordinates(this.get_iframe());
        var bn = new tab.NonApiCommand('layoutInfoResp', [(e.left - bm.left).toString(), (e.top - bm.top).toString(), e.width.toString(), e.height.toString()]);
      ...
      $8: function() {
        ...
        var e = new tab.NonApiCommand('tableau.enableVisibleRectCommunication', []);
      ...
      sendScaleFactor: function(e) {
        ...
        var bn = 0;
        var bo = 0;
        var bp = new tab.NonApiCommand('sf', [e, bm.toString(), bn.toString(), bo.toString()]);
      ...
      $z: function(e) {
        this.get__workbookImpl()._update(ss.mkdel(this, function() {
          if (!ss.staticEquals(this.$1$7, null)) {
            this.$1$7(new x('customviewload', this.$1p, (ss.isValue(e) ? e._impl : null)))
          }
        }))
      },
      $B: function(e) {
      ...
      $s: function(e) {
        ...
        var bn = new tab._Deferred;
        var bo = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.InvokeCommandCommand', 0, ss.mkdel(this, function(bp) {
      ...
      $t: function(e, bm) {
        ...
        var bo = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.InvokeCommandCommand', 0, null, null);
      ...
      $h: function(e) {
        ...
        if (ss.referenceEquals(bn.get_name(), e.get_worksheetName())) {
          ...
          } else if (ss.referenceEquals(br.get_name(), e.get_worksheetName())) {
            bm = br
          }
        }
        if (ss.isValue(bm)) {
      ...
      $e: function(e) {
        ...
        if (!ss.staticEquals(this.$1$10, null) && ss.isValue(bm.defaultCustomViewId)) {
          var bn = this.$1s.$i();
      ...
      $6: function(e) {
        ...
        bm.style.background = "transparent url('" + this.$1n.staticImageUrl + "') no-repeat scroll 0 0";
        bm.style.left = '8px';
      ...
      switchToViz: function(e) {
        ...
        var bo = new(ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))('api.SwitchViz', 1, function(bp) {
          bm.resolve()
        }, function(bp, bq) {
          bm.reject(tab._TableauException.createServerError(bq))
        });
    ...
    ss.initClass(W, a, {
      ...
      $0: function(e) {
        ...
        this.$4 = tab.ApiEnumConverter.convertFieldAggregation(ss.coalesce(e.fieldAggregation, 'NONE'))
      }
    });
    ss.initClass(Q, a, {
    ...
    ss.initClass(ba, a, {
      ...
      $8: function(e) {
        if (ss.isValue(e.periodType)) {
          this.$9 = tab.ApiEnumConverter.convertPeriodType(ss.unbox(e.periodType))
        }
        if (ss.isValue(e.rangeType)) {
          this.$b = tab.ApiEnumConverter.convertDateRange(ss.unbox(e.rangeType))
        }
